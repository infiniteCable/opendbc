...
def create_acc_accel_control(packer, bus, acc_type, acc_enabled, upper_jerk, lower_jerk, upper_control_limit, lower_control_limit,
  ...
  values = {
    ...
    "ACC_zul_Regelabw_unten":     lower_control_limit if acc_control == ACC_CTRL_ACTIVE else 0,
    "ACC_zul_Regelabw_oben":      upper_control_limit if acc_control == ACC_CTRL_ACTIVE else 0,
