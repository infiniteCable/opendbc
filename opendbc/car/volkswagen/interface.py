...
class CarInterface(CarInterfaceBase):
  ...
  def _get_params(ret: structs.CarParams, candidate: CAR, fingerprint, car_fw, experimental_long, docs) -> structs.CarParams:
    ...
    if ret.flags & VolkswagenFlags.PQ:
      ...
      ret.steerActuatorDelay = 0.25 # original 0.15 + 0.1 curvature smooothing
      ret.lateralTuning.pid.kpBP = [15., 30., 38.]
      ret.lateralTuning.pid.kiBP = [15., 30., 38.]
      ret.lateralTuning.pid.kf = 1.
      ret.lateralTuning.pid.kpV = [0., 0., 0.] #[0.00001, 0.3, 1.]
      ret.lateralTuning.pid.kiV = [0., 0., 0.] #[0., 0.00001, 0.0001]
    else:
