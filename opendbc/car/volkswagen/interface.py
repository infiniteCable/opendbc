...
class CarInterface(CarInterfaceBase):
  ...
  def _get_params(ret: structs.CarParams, candidate: CAR, fingerprint, car_fw, experimental_long, docs) -> structs.CarParams:
    ...
    if ret.flags & VolkswagenFlags.PQ:
      ...
      ret.steerActuatorDelay = 0.23 # original 0.15, adding 0.08 because of curvature smooothing
      ret.lateralTuning.pid.kpBP = [0., 30., 45.]
      ret.lateralTuning.pid.kiBP = [0.]
      ret.lateralTuning.pid.kf = 1.
      ret.lateralTuning.pid.kpV = [0.0, 0.3, 0.8] #[0.0, 0.18, 0.65] without delay and int/ext
